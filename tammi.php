...
<BODY>
<IMG SRC="js_purple.jpg" width="400px"><BR />
...
<STRONG>Write a joke on Tammi's page</STRONG>
<FORM METHOD="POST" ACTION="new_joke.php?for=tammi">
...
<BR /><BR />
<STRONG>Tammi's Joke Feed</STRONG><BR />
<?PHP

// Print jokes on users page
$user = 'tammi';
$sql = "SELECT * FROM jokes WHERE forUser = 'tammi' ORDER BY id DESC" ;
...
<a href="http://jax.jokeswaps.com" target="_top">Jack's Joke Swap</a><BR />
<a href="http://felix.jokeswaps.com" target="_top">Jack's Joke Swap</a><BR />
