...
<STRONG>Write a joke on Jax's page</STRONG>
<FORM METHOD="POST" ACTION="new_joke.php?for=jax">
...
<BR /><BR />
<STRONG>Jax's Joke Feed</STRONG><BR />
<?PHP

// Print jokes on users page
$sql = "SELECT * FROM jokes WHERE forUser = 'jax' ORDER BY id DESC" ;
